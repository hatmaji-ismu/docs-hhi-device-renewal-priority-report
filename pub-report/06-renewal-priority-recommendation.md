...
| **Diana** | Mati mendadak, gangguan Excel dan ORS Payroll, RAM kritis (85%), SSD panas (61°C) | Ganti dengan desktop untuk workload administrasi (i5 gen 12+, RAM 16 GB, SSD 512 GB, reliable PSU) | Batch 1 - Fase 1 |
...
| **Yohana** | RAM sangat terbatas (92%), gangguan input (kursor hilang), monitor terlalu kecil | Upgrade interim: tambah RAM ke 16 GB, ganti monitor 24"; siapkan penggantian desktop | Batch 2 - Fase 2 |
...
**Timeline:** 1-3 bulan setelah persetujuan anggaran
...
2. Diana (gangguan aplikasi bisnis kritis)
...
**Timeline:** 3-6 bulan setelah Fase 1
...
3. Yohana (ergonomi dan performa)
...
Implementasi rekomendasi ini akan mengubah armada perangkat dari state of risk menjadi state of reliability dan performance dalam timeframe 6-9 bulan.